...
const response = await fetchCartItems();
  ...
  useEffect(() => {
    if (!user) {
      navigate("/login", {
        state: { from: "/checkout", directBuyItem },
      });
    }
  }, [user, navigate]);
    ...
    <div className="checkout-wrapper">
      <header className="checkout-header">
        <div className="header-inner">
          ...
          <h1 className="header-title">주문/결제</h1>
        </div>
      </header>
          ...
          <form className="checkout-form" onSubmit={handleSubmit}>
            ...
            <div className="checkout-summary">
              <div className="checkout-card sticky-summary">
                <h2 className="checkout-card-title">주문 상품</h2>
                ...
                <div className="summary-price-box">
                  <div className="summary-line">
                    <span>상품 금액</span>
                    <span>{checkoutTotalPrice.toLocaleString()}원</span>
                  </div>
                  <div className="summary-line">
                    <span>배송비</span>
                ...
                <Button className="checkout-pay-btn" disabled={loading}>
                  {loading ? "결제 중..." : `${checkoutTotalPrice.toLocaleString()}원 결제하기`}
                </Button>
              </div>
            </div>
          </form>
