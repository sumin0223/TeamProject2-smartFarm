    ...
    return (
        <div className={styles["farm-card"]} onClick={onClick}>
            ...
            <div className={styles["farm-card-content"]}>
                ...
                <p className={styles["farm-card-system"]}>{farm.presetName}</p>
                ...
                <div className={styles["farm-card-info"]}>
                    <div className={styles["farm-info-item"]}>
                        ...
                        <span
                            className={
                                styles[("info-value", "info-value-green")]
                            }
                        >
                            {farm.plantType}
                        </span>
                    ...
                    <div className={styles["farm-info-item"]}>
                        ...
                        <span
                            className={
                                styles[("info-value", "info-value-blue")]
                            }
                        >
                            {farm.stepId}
                        </span>
                    ...
                    <div className={styles["farm-info-item"]}>
                        ...
                        <span
                            className={
                                styles[("info-value", "info-value-purple")]
                            }
                        >
                            {elapsedDays}일
                        </span>
